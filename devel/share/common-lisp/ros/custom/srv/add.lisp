...
(cl:defmethod cl:initialize-instance :after ((m <add-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom-srv:<add-request> is deprecated: use custom-srv:add-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <add-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom-srv:a-val is deprecated.  Use custom-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <add-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom-srv:b-val is deprecated.  Use custom-srv:b instead.")
  (b m))
...
(cl:defmethod cl:initialize-instance :after ((m <add-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom-srv:<add-response> is deprecated: use custom-srv:add-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <add-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom-srv:sum-val is deprecated.  Use custom-srv:sum instead.")
  (sum m))
